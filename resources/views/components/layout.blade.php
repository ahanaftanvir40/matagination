    ...
    toggleSidebar() {
        ...
        <div class="w-full md:w-64 bg-[#2a1a4a] min-h-screen fixed md:fixed left-0 top-0 z-20 transform transition-transform duration-300 ease-in-out" 
            ...
            <div class="p-6 space-y-4">
                <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 {{ Request::routeIs('dashboard') ? 'bg-purple-700 hover:bg-purple-600 text-white' : 'text-gray-400' }} px-6 py-3 rounded-full w-full hover:bg-gray-700 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                    <span>Dashboard</span>
                </a>
                <a href="{{ route('update-details') }}" class="flex items-center space-x-3 {{ Request::routeIs('update-details') ? 'bg-purple-700 hover:bg-purple-600 text-white' : 'text-gray-400' }} px-6 py-3 rounded-full w-full hover:bg-gray-700 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
